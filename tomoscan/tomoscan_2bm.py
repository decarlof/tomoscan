...
class TomoScan2BM():
    ...
    def __init__(self, instance_name, pv_files, macros):
        # composition with delegation, create instance
        self.instance = getattr(sys.modules[__name__], instance_name)(pv_files, macros)
    ...
    # composition with delegation, called when an attribute is not found:
    ...
    def set_scan_exposure_time(self, exposure_time=None):
        ...
        if(camera_model=='Q-12A180-Fm/CXP-6'):
            ...
            self.instance.set_scan_exposure_time(exposure_time)
